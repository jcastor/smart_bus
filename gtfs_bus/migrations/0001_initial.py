...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gtfs_bus_calendar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('gtfs_bus', ['Calendar'])
        ...
        db.create_table('gtfs_bus_trip', (
            ...
            ('service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gtfs_bus.Calendar'])),
        ...
        db.create_table('gtfs_bus_stoptimes', (
            ...
            ('arrival_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('departure_time', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('display_time', self.gf('django.db.models.fields.TimeField')()),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('gtfs_bus_calendar')
    ...
    models = {
        ...
        'gtfs_bus.calendar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service_id': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        'gtfs_bus.stoptimes': {
            ...
            'arrival_time': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'departure_time': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'display_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'gtfs_bus.trip': {
            ...
            'service_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gtfs_bus.Calendar']"}),
